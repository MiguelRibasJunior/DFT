        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
              {/* Instagram Official Link (Required) */}
              <a
                href={settings?.instagram || "https://www.instagram.com/devsfromtomorrow/?utm_source=ig_web_button_share_sheet"}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram Oficial Devs From Tomorrow"
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = '#28D7E5';
                  e.currentTarget.style.color = '#28D7E5';
                }}
                onMouseLeave={(e) => {
              ...
              <a
                href={settings?.linkedin || "https://linkedin.com/company/devs-from-tomorrow"}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn Devs From Tomorrow"
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = '#2388FF';
                  e.currentTarget.style.color = '#2388FF';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = 'var(--border-gray)';
                  e.currentTarget.style.color = 'var(--text-gray)';
              ...
              <a
                href="https://github.com/devs-from-tomorrow"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GitHub Devs From Tomorrow"
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = '#7B4DFF';
                  e.currentTarget.style.color = '#7B4DFF';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = 'var(--border-gray)';
                  e.currentTarget.style.color = 'var(--text-gray)';
